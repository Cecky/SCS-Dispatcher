...
namespace ScsDispatcher
{
    public partial class FrmMainApp : Form
    {
        ...
        // DEBUGGING
        private void MenuItemWrite3nkETS_Click(object sender, EventArgs e)
        {
            LanguageGenerator.Write3nk(@"d:\temp\ets_3nk.txt", ScsDictionary.GameID.ETS);
        }
        private void MenuItemWrite3nkATS_Click(object sender, EventArgs e)
        {
            LanguageGenerator.Write3nk(@"d:\temp\ats_3nk.txt", ScsDictionary.GameID.ATS);
        }
